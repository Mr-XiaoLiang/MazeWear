...
open class CircularProgressIndicator @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        attributeSet?.let { attr ->
            context.withStyledAttributes(attr, R.styleable.CircularProgressIndicator) {
                progress = getFloat(
                ...
                interval = getDimensionPixelSize(
                ...
                val isAntiClockwise = getBoolean(
